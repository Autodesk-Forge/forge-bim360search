    ...
    public class OAuthController : ControllerBase
    {
        ...
        public string GetOAuthURL()
        {
            ...
            string oauthUrl = _threeLeggedApi.Authorize(
              Config.GetAppSetting("FORGE_CLIENT_ID"),
              oAuthConstants.CODE,
              Config.GetAppSetting("FORGE_CALLBACK_URL"),
    ...
    public class Credentials
    {
        ...
        public static async Task<Credentials> CreateFromCodeAsync(string code, IResponseCookies cookies)
        {
            ...
            dynamic credentialInternal = await oauth.GettokenAsync(
              ...
              oAuthConstants.AUTHORIZATION_CODE, code, Config.GetAppSetting("FORGE_CALLBACK_URL"));
        ...
        public static async Task<Credentials> FromSessionAsync(IRequestCookieCollection requestCookie, IResponseCookies responseCookie)
        {
            ...
            if (credentials.TokenInternal == null || credentials.TokenPublic == null || credentials.RefreshToken == null || credentials.UserId == null) return null;
        ...
        {
            if (ExpiresAt > DateTime.Now) return;
